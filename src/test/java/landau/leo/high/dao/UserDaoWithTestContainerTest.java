...
@Testcontainers
@SpringBootTest
public class UserDaoWithTestContainerTest {
    ...
    void insertTest() {
        ...
        assertThrows(AuthenticationCredentialsNotFoundException.class, () -> userDao.getUserById(userId.toString()));

        userDao.insert(userEntity);

        assertEquals(userEntity, userDao.getUserById(String.valueOf(userId)));
    }
