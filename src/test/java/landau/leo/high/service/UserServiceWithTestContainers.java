...
@Testcontainers
@SpringBootTest
class UserServiceWithTestContainers {
    ...
    void authenticateUserWithIncorrectPassword() {
        ...
        when(userDao.getUserById(request.getId())).thenReturn(userEntity);
    ...
    void getUserById() {
        ...
        when(userDao.getUserById(anyString())).thenReturn(userEntity);
